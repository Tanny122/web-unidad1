...
public class SueldoIndefinido extends Empleado{
    public SueldoIndefinido(int ide, String nomb, String ape, String fl, float si, int pi, int pr){
    ...
    public void calcularbonificacion() {
        if (super.porcentaje > 90){
            float total =  (float) (super.sueldo*1.10);
